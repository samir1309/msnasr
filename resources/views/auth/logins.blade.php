...
<div class="vh-100 d-flex align-items-center">
	<div class="splash-container">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{URL::action('App\Http\Controllers\Admin\LoginController@postLogin')}}" method="POST"
                    ...
                    <div class="g-recaptcha" data-sitekey="6LeziW4fAAAAAOjWEr-Xpi2L5P5Qk9E7LSjv4Pv0"></div>
