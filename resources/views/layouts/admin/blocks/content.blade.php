    ...
    <div class="container-fluid dashboard-content ">
        ...
        <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <a href="{{URL::action('App\Http\Controllers\Admin\ProductController@getProduct')}}" class="text-decoration-none">
                        <div class="card">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <a href="{{URL::action('App\Http\Controllers\Admin\CategoryController@getCategory')}}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body d-flex">
                                <div class="metric-value d-inline-block w-100">
                                    <h2 class="m-0 d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <a href="{{URL::action('App\Http\Controllers\Admin\BrandController@getBrand')}}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body d-flex">
                                <div class="metric-value d-inline-block w-100">
                                    <h2 class="m-0 d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <a href="{{URL::action('App\Http\Controllers\Admin\ArticleController@getArticle')}}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body d-flex">
                                <div class="metric-value d-inline-block w-100">
                                    <h2 class="m-0 d-flex align-items-center justify-content-between">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <a href="{{URL::action('App\Http\Controllers\Admin\ArticleController@getArticleCat')}}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body d-flex">
                                <div class="metric-value d-inline-block w-100">
                                    <h2 class="m-0 d-flex align-items-center justify-content-between">
                    ...
                    @if(Auth::user()->hasPermission('slider'))
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                            <a href="{{URL::action('App\Http\Controllers\Admin\SliderController@getSlider')}}" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body d-flex">
                                        <div class="metric-value d-inline-block w-100">
                                            <h2 class="m-0 d-flex align-items-center justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                        <a href="{{URL::action('App\Http\Controllers\Admin\OrderController@getIndex')}}" class="text-decoration-none">
                            <div class="card">
                                <div class="card-body d-flex">
                                    <div class="metric-value d-inline-block w-100">
                                        <h2 class="m-0 d-flex align-items-center justify-content-between">
                    ...
                    @if(Auth::user()->hasPermission('redirect'))
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                            <a href="{{URL::action('App\Http\Controllers\Admin\RedirectController@getRedirect')}}" class="text-decoration-none">
                                <div class="card">
                                    <div class="card-body d-flex">
                                        <div class="metric-value d-inline-block w-100">
                                            <h2 class="m-0 d-flex align-items-center justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                        <a href="{{URL::action('App\Http\Controllers\Admin\SettingController@getEditSetting')}}" class="text-decoration-none">
                            <div class="card">
                                <div class="card-body d-flex">
                                    <div class="metric-value d-inline-block w-100">
                                        <h2 class="m-0 d-flex align-items-center justify-content-between">
