	...
	<div class="row w-100 m-0">
		...
		<div class="col-lg-6 mx-auto py-1 px-0">
			...
			<div class="card rounded-lg border-0 p-3">
				<form method="post" action="{{URL::action('App\Http\Controllers\Admin\ProductController@postEditTimer',$data->id)}}"
			...
			@else
			<div class="card rounded-lg border-0 p-3">
				<form method="post" action="{{URL::action('App\Http\Controllers\Admin\ProductController@postTimer')}}"
					enctype="multipart/form-data">
					@include('admin.timer.form')
				</form>
			</div>
