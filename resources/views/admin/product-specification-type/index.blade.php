...
<div class="container-fluid  dashboard-content">
    ...
    <div class="row w-100 m-0">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
            @if($parent)
                <a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@getList',$parent->parent_id)}}" class="btn btn-default btn-info" style="float: left" data-toggle="tooltip" data-placement="top" title="" data-original-title="بازگشت">
                    بازگشت
	...
	<div class="card">
				...
				<form method="post" action="{{url('/admin/product-specification-type/delete')}}" style="float: left">
				{{ csrf_field() }}  
			<div class="py-3 px-2">
                ...
                <a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@getAdd',$parent_id)}}"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td>
															<a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@getEdit',$row['id'])}}"
																type="button"
																class="btn btn-space btn-warning"
																data-toggle="tooltip" title="ویرایش">
																<i class="fa fa-edit"> </i>
															</a>
                                                            <a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@getDelete',$row['id'])}}"
                                                               type="button"
															...
															<a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@getList',$row['id'])}}"
																type="button"
																class="btn btn-space btn-secondary"
	...
	<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@postCatAdd')}}">
					{{ csrf_field() }}
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@getCatDelete',[$row->id,$item->id])}}"
