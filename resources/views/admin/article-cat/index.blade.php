											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td>
															<a href="{{URL::action('App\Http\Controllers\Admin\ArticleController@getEditArticleCat',$article->id)}}"
																type="button"
																class="btn btn-space btn-warning"
																data-toggle="tooltip" title="ویرایش">
																<i class="fa fa-edit"> </i>
															</a>
                                                            <a href="{{URL::action('App\Http\Controllers\Admin\ArticleController@getDeleteArticleCat',$article->id)}}"
