...
@section('title') {{'شعارهای '.$product->title}} @endsection
@section('content')
	...
	<div class="card">
		<form method="post" action="{{url('/admin/sloagen/delete')}}" style="float: left">
			...
			<div class="px-2 py-3">
				...
				<a href="{{URL::action('App\Http\Controllers\Admin\SloagenController@getAdd' , $id)}}" type="button" class="btn btn-space btn-primary">
                    	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td>
															<a href="{{URL::action('App\Http\Controllers\Admin\SloagenController@getEdit',$sloagen->id)}}"
																type="button"
