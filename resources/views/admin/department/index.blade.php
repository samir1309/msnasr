        ...
        <div class="row w-100 m-0">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
                ...
                <div class="card" id="app34534567">
                    <h5 class="card-header">دپارتمان جدید</h5>
                    <div class="card-body">
                        <form method="post"
                              action="{{URL::action('App\Http\Controllers\Admin\DepartmentController@postAdd')}}"
        ...
        <div class="row w-100 m-0">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
                <div class="card">
                    ...
                    <form method="post" action="{{URL::action('App\Http\Controllers\Admin\DepartmentController@postDelete')}}">
                        {{ csrf_field() }}
                        <div class="py-3 px-2">
                            ...
                            {{--                        <a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationController@getAdd',$product_id)}}" type="button"--}}
                        ...
                        <div class="row w-100 m-0">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">لیست دپارتمان ها</h5>
                                                        ...
                                                        <table class="table table-striped table-bordered first dataTable"
                                                            ...
                                                            @foreach($data as $key=> $row)
                                                                <tr role="row" class="odd">
                                                                    ...
                                                                    <td>
                                                                        <button  type="button" class="btn btn-info" data-toggle="modal" data-target="#edit{{$row->id}}">ویرایش نام
                                                                        </button>
                                                                    </td>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{URL::action('App\Http\Controllers\Admin\DepartmentController@postEdit',$row->id)}}">
                            {{ csrf_field() }}
