...
<div class="container-fluid  dashboard-content">
	...
	<form method="post" action="{{url('/admin/category/delete')}}" style="float: left">
			...
			<div class="py-3 px-2">
				...
				<a href="{{URL::action('App\Http\Controllers\Admin\CategoryController@getAddCategory')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
                                                        ...
                                                        <td class="sorting_1">
                                                            {{@$row['status'] == 1 ? 'نمایش در صفحه' : 'عدم نمایش در صفحه'}}
                                                        </td>
														<td>
															...
															<a href="{{route('site.product.list',['id'=>$row->id])}}"
