...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
			...
			<div class="">
				...
				<div class="px-2 py-3">
					<a href="{{URL::action('App\Http\Controllers\Admin\RedirectController@getRedirectAdd')}}" type="button" class="btn btn-space btn-primary">
												...
												<table
                                                    ...
                                                    @foreach($redirect as $key=> $row)
														<tr role="row" class="odd">
															...
															<td>
																<a href="{{URL::action('App\Http\Controllers\Admin\RedirectController@getRedirectDelete',$row->id)}}"
																	type="button"
