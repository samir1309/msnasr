        ...
        <div class="row w-100 m-0">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
                ...
                <div class="card" id="app34534567">
                    <h5 class="card-header">وضعیت جدید</h5>
                    <div class="card-body">
                        <form method="post"
                              action="{{URL::action('App\Http\Controllers\Admin\StatusController@postAdd')}}"
        ...
        <div class="row w-100 m-0">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0">
                <div class="card">
                    ...
                    <form method="post" action="{{URL::action('App\Http\Controllers\Admin\StatusController@postDelete')}}">
                        {{ csrf_field() }}
                        <div class="py-3 px-2">
                        ...
                        <div class="row w-100 m-0">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">لیست وضعیت ها</h5>
                ...
                <div class="modal-content">
                   ...
                   ویرایش نام
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{URL::action('App\Http\Controllers\Admin\StatusController@postEdit',$row->id)}}">
                            {{ csrf_field() }}
