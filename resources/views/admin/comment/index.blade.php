												...
												<table
													...
													<tbody>
														...
														<tr role="row" class="odd">
															...
															<td>
                                                                <a href="{{URL::action('App\Http\Controllers\Admin\CommentController@getDelete',$row->id)}}" type="button" class="btn btn-danger my-1 btn-circle"><i class="fa fa-trash"> </i></a>
