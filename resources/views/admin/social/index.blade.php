...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
			...
			<div class="">
				...
				<div class="px-2 py-3">
					<a href="{{URL::action('App\Http\Controllers\Admin\SocialController@getAdd')}}" type="button" class="btn btn-space btn-primary">
												...
												<table
                                                    ...
                                                    @foreach($uploader as $key=> $upl)
														<tr role="row" class="odd">
															...
															<td>
                                                                <a href="{{URL::action('App\Http\Controllers\Admin\SocialController@getEdit',$upl->id)}}"
                                                                   type="button"
																...
																<a href="{{URL::action('App\Http\Controllers\Admin\SocialController@getDelete',$upl->id)}}"
																	type="button"
