...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
		<form method="post" action="{{URL::action('App\Http\Controllers\Admin\UserController@postGroupDelete')}}">
			{{ csrf_field() }}
			<div class="py-3 px-2">
				...
				<a href="{{URL::action('App\Http\Controllers\Admin\UserController@getGroupAdd')}}" type="button" class="btn btn-space btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
												...
												<tbody>
													...
													<tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                                ...
                                                                <a href="{{URL::action('App\Http\Controllers\Admin\UserController@getGroupEdit',[$row->id])}}"
...
{{--                        $.post("{!!URL::action('App\Http\Controllers\Admin\ArticleController@postSort')!!} ", order, function (theResponse) {--}}
