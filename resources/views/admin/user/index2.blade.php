...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
                ...
                <div id="myModal2" class="modal">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-3">
                                <form method="GET" action="{{URL::action('App\Http\Controllers\Admin\UserController@export')}}" class="m-0">
		...
		<form method="post" action="{{URL::action('App\Http\Controllers\Admin\UserController@postDelete')}}">
			{{ csrf_field() }}
			<div class="py-3 px-2">
...
{{--				<a href="{{URL::action('App\Http\Controllers\Admin\UserController@getAdd')}}" type="button" class="btn btn-space btn-primary">--}}
{{--                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"--}}
...
{{--                                                            </button>--}}
                                                            <a href="{{URL::action('App\Http\Controllers\Admin\UserController@getEdit2',[$row->id])}}"
                                                               data-toggle="tooltip" data-original-title="ویرایش اطلاعات"
                                                               class="btn btn-xs  btn-warning"><i class="fa fa-edit"></i> ویرایش </a>
                                                            <a href="{{URL::action('App\Http\Controllers\Admin\UserController@getAddress',[$row->id])}}"
...
{{--                                                                <a href="{{URL::action('App\Http\Controllers\Admin\LoginController@getUserlogin',[$row->id])}}"--}}
