...
@section('title') {{'سایر مشخصات '.$product->title}} @endsection
@section('content')
<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
        <div class="card col-lg-8">
            <div class="row w-100 m-0">
		<form method="post" action="{{url('/admin/properties/delete')}}" style="float: left">
			{{ csrf_field() }}
			<div class="px-2 py-3">
				...
				<a href="{{URL::action('App\Http\Controllers\Admin\PropertiesController@getAdd' , $id)}}" type="button" class="btn btn-space btn-primary">
                    	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td class="sorting_1">{{@$question->description}}</td>
														<td class="sorting_1">{{$question->status  ? 'بالایی' : 'پایینی'}}</td>
														<td>
															<a href="{{URL::action('App\Http\Controllers\Admin\PropertiesController@getEdit',$question->id)}}"
																type="button"
                ...
                <div class="col-lg-4">
                    <div id="list">
                        ...
                        <ul>
                            ...
                            @foreach($questionsort as $rowSort)
                                <li class="list-unstyled  my-2 p-3 shadow-sm rounded-lg" id="arrayorder_{!! stripslashes($rowSort['id']) !!}"  style="background-color: #333" >{!! stripslashes($rowSort['description']) !!}
                                    <div class="clear"></div>
                                </li>
                    ...
                    $(function () {
                        $("#list ul").sortable({
                            opacity: 0.8, cursor: 'move', update: function () {
                                ...
                                $.post("{!!URL::action('App\Http\Controllers\Admin\PropertiesController@postSort')!!} ", order, function (theResponse) {
