    ...
    <div class="container-fluid dashboard-content" role="main" id="feature " >
        <div class="row w-100 m-0" id="3434w5e4w">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-0" id="productform">
                ...
                <form method="post"
                      action="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationPriceController@postAddGroup',$product_id)}}"
                ...
                <div class="card">
                    <div class="card-body" id="price68">
                        <form method="post"
                              action="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationPriceController@postAdd',$product_id)}}"
                              enctype="multipart/form-data" id="rahweb_form">
            ...
            $(function () {
                $("#list ul").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        $.post("{!!URL::action('App\Http\Controllers\Admin\ProductSpecificationPriceController@postSort')!!} ", order, function (theResponse) {
