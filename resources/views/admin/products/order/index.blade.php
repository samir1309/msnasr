...
<div class="container-fluid  dashboard-content">
    ...
    <div class="card">
{{--        <form method="post" action="{{url('/admin/inventory/delete')}}">--}}
{{--            {{ csrf_field() }}--}}
            <div class="py-3 px-2">
...
{{--                    حذف انتخاب شده ها--}}
{{--                </button>--}}
{{--                <a href="{{url('admin/inventory/add')}}" type="button" class="btn btn-space btn-primary">--}}
{{--                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"--}}
...
{{--                                                        </td>--}}
                                                        ...
                                                        <td class="sorting_1">{{@$row->sale->id}}</td>
