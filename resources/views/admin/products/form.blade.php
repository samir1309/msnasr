...
<div class="row w-100 m-0">
           ...
           @if(isset($data) && $data->colors->count() > 0)
            ...
            <div class="row w-100 m-0 bg-light p-2">
                <div class="col-lg-6 p-1 form-group">
                    ...
                    <input id="old_price" name="old_price" type="text" class="form-control channels" value="@if(isset($data)){{@$data->price_admin['old'] ? @$data->price_admin['old'] : @$data->price_admin['price']}}@endif">
                ...
                <div class="col-lg-6 p-1 form-group">
                    ...
                    <input id="price" name="price" type="text" class="form-control channels" value="@if(isset($data->prices[0]->price)){{@$data->price_admin['price'] && (@$data->price_admin['old'] > 0) ? @$data->price_admin['price'] : ''}}@endif">
                </div>
    ...
    <div class="col-lg-6 p-2 form-group">
        <label for="video_link">لینک آپارات:</label>
        <textarea class="form-control" id="video_link" name="video_link" rows="4">@if(isset($data->video_link)){!!$data->video_link !!}@endif</textarea>
    </div>
    <div class="col-lg-6 p-2 form-group">
        <label for="title_seo">
            عنوان سئو :
