        ...
        <div class="row">
            <div class="card col-lg-12">
                ...
                <div class="px-2 py-3">
                    ...
                    <a type="button" href="{{URL::action('App\Http\Controllers\Admin\ProductController@export')}}" class="btn-success btn btn-space">
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="text-center">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div id="myModal1{{$product->id}}" class="modal">
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                                                            <div class="modal-content border-0">
                                                                                ...
                                                                                <div class="modal-body p-3">
                                                                                    <form action="{{URL::action('App\Http\Controllers\Admin\InventoryController@postAddReceipt')}}" method="POST" enctype="multipart/form-data">
                                                                                        {{ csrf_field() }}
                                                                    ...
                                                                    <a href="{{URL::action('App\Http\Controllers\Admin\ProductController@getEditProduct',$product->id)}}"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="w3-container w-100 d-flex align-items-center justify-content-center py-5 overflow-scroll">
                                                                                    <div class="row w-100 m-0">
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationPriceController@getIndex',$product->id)}}"
                                                                                               type="button" target="_blank"
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('App\Http\Controllers\Admin\ProductSpecificationController@getIndex',$product->id)}}"
                                                                                               type="button" target="_blank"
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('App\Http\Controllers\Admin\ProductController@getImage',$product->id)}}"
                                                                                               type="button" target="_blank"
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('App\Http\Controllers\Admin\ProductController@getTimer',$product->id)}}"
                                                                                               type="button" target="_blank"
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('App\Http\Controllers\Admin\QuestionController@get',$product->id)}}"
                                                                                               type="button" target="_blank"
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('App\Http\Controllers\Admin\SloagenController@get',$product->id)}}"
                                                                                               type="button" target="_blank"
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('App\Http\Controllers\Admin\PropertiesController@get',$product->id)}}"
                                                                                               type="button" target="_blank"
                                                                                       ...
                                                                                       <a href="{{route('site.product.detail',['id'=>$product->id])}}"
                                                                                        ...
                                                                                        <div class="col p-1">
                                                                                            <a href="{{URL::action('App\Http\Controllers\Admin\ProductController@getDeleteProduct',$product->id)}}"
                ...
                $("#list ul").sortable({
                    ...
                    update: function() {
                        ...
                        var order = $(this).sortable("serialize") + '&update=update' +
                            '&_token=' + CSRF_TOKEN;
                        $.post("{!!URL::action('App\Http\Controllers\Admin\ProductController@postSort')!!} ",
                            order,
