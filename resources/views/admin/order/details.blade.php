    ...
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row w-100 m-0">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <table
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    style="width: 80.0667px;"
                                                    aria-sort="ascending"
                                                    aria-label="Name: activate to sort column descending">{{jdate(' H:s Y/m/d ',@$order->created_at->timestamp)}}</th>
                                            </tr>
                ...
                <a href="{{URL::action('App\Http\Controllers\Admin\OrderController@getfactor',$order->id)}}"
                   type="button"
                ...
                <a href="{{URL::action('App\Http\Controllers\Admin\OrderController@getAddress',$order->id)}}"
                   type="button"
                   class="btn btn-space btn-info"
                   data-toggle="tooltip" target="_blank"
                   title="چاپ آدرس">
                                ...
                                <div class="row w-100 m-0">
                                    <div class="col-sm-12">
                                        <table
                                            ...
                                            <tr role="row">
                                                <form
                                                    action="{{URL::action('App\Http\Controllers\Admin\OrderController@orderStatus',$order->id)}}"
                                                    method="POST">
                                                    {{ csrf_field() }}
                                ...
                                <table
                                    ...
                                    @foreach($orders as $key=> $row)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a href="{{URL::action('App\Http\Controllers\Admin\OrderController@getDetail',$row['id'])}}"
                                                   type="button"
                                                   class="btn btn-space btn-info"
                                                   data-toggle="tooltip"
                                                   title="جزئیات فاکتور">
