...
<div class="container-fluid  dashboard-content">
	...
	<div class="card">
                ...
                <div id="myModal2" class="modal">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content border-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,0.2);">
                            ...
                            <div class="modal-body p-3">
                                <form method="GET" action="{{URL::action('App\Http\Controllers\Admin\OrderController@export')}}" class="m-0">
                                    <div class="row w-100 m-0">
                                        <div class="col-md-6 p-1">
		...
		<form method="post" action="{{URL::action('App\Http\Controllers\Admin\OrderController@postDelete')}}" style="float: left">
			{{ csrf_field() }}
			<div class="px-3">
