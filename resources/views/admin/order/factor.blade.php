...
<div class="page">
    <table class="header-table tableyek" style="width: 100%;direction: rtl;
float: right;
text-align: center;">
        <tbody>
        <tr>
            ...
            <td style="padding: 0 0 5px;">
                <div class="bordered grow header-item-data">
                    <table class="grow centered" style="style="direction: rtl;
float: right;
text-align: center;"">
                        <tbody>
                        <tr
    ...
    <table class="content-table tabledo  dir-rtl" style="margin-bottom:0.25rem;direction: rtl;
float: right;
text-align: center;">
        <thead>
        <tr>
    ...
    <table class="content-table tablese  " style="direction: rtl;
float: right;
text-align: center;">
        <thead>
        <tr>
