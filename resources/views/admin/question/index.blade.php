...
@section('title') {{'سوالات متداول '.$product->title}} @endsection
@section('content')
	...
	<div class="card">
		<form method="post" action="{{url('/admin/question/delete')}}" style="float: left">
			...
			<div class="px-2 py-3">
				...
				<a href="{{URL::action('App\Http\Controllers\Admin\QuestionController@getAdd' , $id)}}" type="button" class="btn btn-space btn-primary">
                    	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													@foreach($questions as $key=> $question)
														...
														<td class="sorting_1">{{@$question->answer}}</td>
														<td>
															<a href="{{URL::action('App\Http\Controllers\Admin\QuestionController@getEdit',$question->id)}}"
																type="button"
