        ...
        <div class="card">
            <form method="post" action="{{url('/admin/question/delete')}}" style="float: left">
                ...
                <div class="px-2 py-3">
                    ...
                    <a href="{{URL::action('App\Http\Controllers\Admin\QuestionController@getAddFaq')}}" type="button" class="btn btn-space btn-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                ...
                                                <table class="table table-striped table-bordered first dataTable"
                                                    ...
                                                    @foreach($questions as $key=> $question)
                                                        <tr role="row" class="odd" @if($question->answer == null) style="background-color:cyan" @endif>
                                                            ...
                                                            <td>
                                                                <a href="{{URL::action('Admin\QuestionController@getEdit',$question->id)}}"
                                                                   type="button"
