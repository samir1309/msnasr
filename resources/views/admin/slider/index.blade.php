											...
											<table class="table table-striped table-bordered first dataTable"
												...
												<tbody>
													...
													<tr role="row" class="odd">
														...
														<td class="sorting_1">
															<img src="{{asset('assets/uploads/content/sli/'.$row->image)}}" style="width: 50%;">
														</td>
														<td>
                                                        <a href="{{url('/admin/slider/edit' , $row->id) }}"
																type="button"
            ...
            $(function () {
                $("#list ul").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        $.post("{!!URL::action('App\Http\Controllers\Admin\SliderController@postSort')!!} ", order, function (theResponse) {
