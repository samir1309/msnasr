<div class="border bg-light shadow-sm p-2 ">
	<div class="row w-100 m-0 gy-2">
        ...
        <form action="{{URL::action('App\Http\Controllers\Panel\TicketController@postTicketDetails')}}" method="post" class="m-0">
            @csrf
...
@if($start->status !== 2)
    <div class="box-footer">
        ...
        <a href="{{URL::action('App\Http\Controllers\Panel\TicketController@ticketStatus',$start->id)}}"
