...
<div class="favorit h-100 py-1">
	<div class="row w-100 m-0">
								...
								<tr>
									...
									<td class="text-center text-secondary" style="vertical-align: middle;">
										<div class=" d-flex align-items-center justify-content-center">
    										...
    										<a href="{{URL::action('App\Http\Controllers\Panel\PanelController@getDeleteAddress',$address->id)}}"
    										...
    										@else
    										<a href="{{URL::action('App\Http\Controllers\Panel\PanelController@defaultAddress',$address->id)}}"
        										data-toggle="tooltip"
		...
		<div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 mx-auto h-100 p-2">
			<form class="m-0" method="post" action="{{URL::action('App\Http\Controllers\Panel\PanelController@postAddAddress')}}"
				...
				<div class="col-lg-4 p-1">
					<div class="form-floating">
						<input type="text" class="form-control" name="name" placeholder="عنوان آدرس" />
						<label for="">
							عنوان آدرس
