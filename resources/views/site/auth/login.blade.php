	...
	<div class="row w-100 m-0">
		<div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-8 col-xs-12 m-auto p-1">
			<div class="card shadow border-0 rounded-0 p-3">
				...
				<form class="mb-0 mt-4" method="POST" action="{{URL::action('App\Http\Controllers\Panel\LoginController@postPassword')}}"
						...
						<div class="col-xxl-12 text-center px-1 py-4">
							<div class="form-floating">
								<p class="m-0">
									...
									<a href="{{ url('/panel/register') }}" class="text-one fw-bolder">
										ثبت نام
									</a>
									کنید
								</p>
