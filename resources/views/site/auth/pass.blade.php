		...
		<div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-8 col-xs-12 m-auto p-1">
			<div class="card shadow border-0 rounded-0 p-3">
				...
				<form class="mb-0 mt-4" method="POST"
					action="{{URL::action('App\Http\Controllers\Panel\LoginController@postPanelLogin')}}" enctype="multipart/form-data">
					{{ csrf_field() }}
				...
				<form class="mb-0 mt-4" method="post"
					action="{{URL::action('App\Http\Controllers\Panel\LoginController@postRePassword',[$user->mobile])}}"
