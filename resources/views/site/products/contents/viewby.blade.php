	...
	<div class="col-xl col-lg-3 col-md-3 col-sm-6 col-xs-6 p-list-custom">
		<div class="card border-0 rounded-0">
			<div class="form-check form-switch">
				...
				<input class="form-check-input m-0" type="checkbox" id="Switch1" @change="filterProducts()" v-model = "available">
			</div>
		</div>
	</div>
    ...
    <div class="col-xl col-lg-3 col-md-3 col-sm-6 col-xs-6 p-list-custom">
        <div class="card border-0 rounded-0">
            <div class="form-check form-switch">
                ...
                <input class="form-check-input m-0" type="checkbox" id="Switch3" @change="filterProducts()" v-model = "timer">
            </div>
        </div>
    </div>
    <div class="col-xl col-lg-3 col-md-3 col-sm-6 col-xs-6 p-list-custom">
