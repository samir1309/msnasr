																		...
																		<div class="col-lg-6 p-1">
																			<div class="card bg-light rounded-0 shadow-sm p-2">
																				...
																				<div class="text-end d-flex justify-content-end">
																					<a href="{{URL::action('App\Http\Controllers\Panel\PanelController@getDeleteAddress',$row->id)}}" type="button"
																				...
																				@if($row->default_address == 1)
																					<a href="{{URL::action('App\Http\Controllers\Site\ShopController@defaultAddress',$row->id)}}" type="button"
