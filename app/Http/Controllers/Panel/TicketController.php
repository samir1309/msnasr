...
class TicketController extends Controller
{
    ...
    public function postNewTicket(Request $request){
        ...
        return Redirect::action('App\Http\Controllers\Panel\TicketController@tickets')->with('success','تیکت شما با موفقیت ثبت شد.');
    }
...
//        ]);
    ...
    public function ticketStatus($id)
    {
        ...
        return Redirect::action('App\Http\Controllers\Panel\TicketController@tickets')->with('success','  با موفقیت ثبت شد.');
    }
