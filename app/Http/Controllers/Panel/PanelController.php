...
/////==============dash===========================================
    ...
    public function savePassword(PassRequest $request){
        ...
        alert()->success('رمز عبور با موفقیت ویرایش شد', 'کاربر عزیز')->persistent('اکی');
    ...
    alert()->success('آدرس با موفقیت اضافه شد', 'کاربر عزیز')->persistent('اکی');
        return redirect()->back();
    ...
    public function orders()
    {
        ...
        $cancel_orders = Order::orderby('id','DESC')->where('user_id',$user->id)->where('order_status_id','4')->get();
