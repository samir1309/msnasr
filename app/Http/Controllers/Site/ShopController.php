    ...
    public static function getCustomOrder($currentOrder)
    {
        ...
        foreach ($currentOrder->orderItems as $item) {
            ...
            $items[] = [
                ...
                'productImage' => asset('assets/uploads/content/pro/big/' . @$item->product->image[0]->file),
                    ...
                    if (($count - $request->quantity) >= $max) {
                        ...
                        if(@$sp !== null){
                            ...
                            OrderItem::create([
                                ...
                                'quantity' => $request->quantity,
                                'order_item_status_id' => 1,
                                'price' => (int)filter_var($product->price_first['price'], FILTER_SANITIZE_NUMBER_INT),
                             //   'old_price' => (int)filter_var($product->price_first['old_price'], FILTER_SANITIZE_NUMBER_INT),
                            ]);
                        }
