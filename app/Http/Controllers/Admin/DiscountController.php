...
class DiscountController extends Controller
{
    ...
    public  function postAdd(Request $request) {
        ...
        return Redirect::action('App\Http\Controllers\Admin\DiscountController@getIndex')
    ...
    public function getEdit($id)
{
    ...
    public function postEdit($id , Request $request)
    {
        ...
        return Redirect::action('App\Http\Controllers\Admin\DiscountController@getIndex')->with('success', 'آیتم جدید اضافه شد.');
    }
