...
class CommentController extends Controller
{
    ...
    public function postEdit($id, Request $request)
    {
        ...
        return Redirect::action('App\Http\Controllers\Admin\CommentController@getIndex')
    ...
    public function getDelete($id)
    {
        ...
        Comment::destroy($id);
        return Redirect::action('App\Http\Controllers\Admin\CommentController@getIndex')->with('success', 'کد مورد نظر با موفقیت حذف شدند.');
