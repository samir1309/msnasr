...
class InventoryController extends Controller
{
    ...
    public function postAdd(Request $request)
    {
        ...
        return Redirect::action('App\Http\Controllers\Admin\InventoryController@get');
    }
    ...
    public function postEdit($id, Request $request)
    {
        ...
        $log = Logs::log(url()->current(),$serialized_array,Auth::id(),$inventory->id);
        return Redirect::action('App\Http\Controllers\Admin\InventoryController@get')->with('success' , 'آیتم مورد نظر با موفقیت ویرایش شد');
    }
    ...
    public function postAddReceipt(Request $request)
    {
        ...
        foreach ($input['count'] as $key=>$item){
            ...
            Helper::changeStockTable(@$input['product_id'][$key]);
