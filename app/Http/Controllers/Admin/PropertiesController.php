...
class PropertiesController extends Controller
{
    ...
    public function postAdd(Request $request)
    {
        ...
        return Redirect::action('App\Http\Controllers\Admin\PropertiesController@get',$input['product_id'])->with('success', 'کدهای مورد نظر با موفقیت ویرایش شدند.');
    }
    ...
    public function postEdit($id, Request $request)
    {
        ...
        return \redirect('/admin/products/properties/'.$properties->product_id)->with('success','آیتم موردنظر با موفقیت ثبت شد.');
    }
