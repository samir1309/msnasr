...
//        $input['url']=str_replace(' ', '-',$input['url']);
        ...
        alert()->success('مقاله شما با موفقیت ارسال شد', 'کاربر عزیز')->persistent('اکی');
        $article->update([
     ...
     //   $serialized_array = serialize($array);
      ...
      //  $log = Logs::log(url()->current(),$serialized_array,Auth::id(),$article->id);
        ...
        return Redirect::action('App\Http\Controllers\Admin\ArticleController@getArticle')->with('success', 'کد مورد نظر با موفقیت اضافه شد');
    }
...
//        }
      ...
      //  $log = Logs::log(url()->current(),$serialized_array,Auth::id(),$content->id);
        return Redirect::action('App\Http\Controllers\Admin\ArticleController@getArticle')->with('success' , 'آیتم مورد نظر با موفقیت ویرایش شد');
    }
    public function getDeleteArticle($id)
    {
     ...
     //   $serialized_array = serialize($array);
       // $log = Logs::log(url()->current(),$serialized_array,Auth::id(),$content->id);
        Content::destroy($id);
        return Redirect::action('App\Http\Controllers\Admin\ArticleController@getArticle')->with('success', 'کدهای مورد نظر با موفقیت حذف شدند.');
...
//        $input['url']=str_replace(' ', '-',$input['url']);
      ...
      //  $log = Logs::log(url()->current(),$serialized_array,Auth::id(),$article->id);
        return Redirect::action('App\Http\Controllers\Admin\ArticleController@getArticleCat')->with('success', 'کد مورد نظر با موفقیت اضافه شد');
    }
...
//        $input['url']=str_replace(' ', '-',$input['url']);
      ...
      //  $log = Logs::log(url()->current(),$serialized_array,Auth::id(),$content->id);
        return Redirect::action('App\Http\Controllers\Admin\ArticleController@getArticleCat')->with('success' , 'آیتم مورد نظر با موفقیت ویرایش شد');
    }
    ...
    //    $log = Logs::log(url()->current(),$serialized_array,Auth::id(),$content->id);
        Content::destroy($id);
        return Redirect::action('App\Http\Controllers\Admin\ArticleController@getArticleCat');
