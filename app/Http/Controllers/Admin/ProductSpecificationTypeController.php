...
class ProductSpecificationTypeController extends Controller
{
    ...
    public function postAddMain(Request $request, $parent_id = null)
    {
        ...
        return Redirect::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@getList', @$parent_id)
    ...
    public function postEdit($id, Request $request)
    {
        ...
        return Redirect::action('App\Http\Controllers\Admin\ProductSpecificationTypeController@getList', @$input['parent_id'])
